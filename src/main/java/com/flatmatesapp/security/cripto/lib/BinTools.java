...
/**
 * Copied from Matthias G&auml;rtner PKCS#5 implementation - see
...
public final class BinTools {
     ...
     * @return Hexadecimal representation of b. Uppercase A-F, two characters per byte. Empty string
     ...
     * 
     * @param s String containing hexadecimal digits. May be <code>null</code>. On odd length
     * leading zero will be assumed.
